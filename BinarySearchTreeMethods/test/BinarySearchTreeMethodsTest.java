...
public final class BinarySearchTreeMethodsTest {
    ...
    @Test
    public void isInTree1() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "a", "c", "D", "g", "e");
        BinaryTree<String> t2 = createBSTFromArgs("b", "a", "c", "D", "g", "e");
        /*
         * Call method under test
         */
    ...
    public void isInTree2() {
         ...
         * Call method under test
         */
        boolean inTree = BinarySearchTreeMethods.isInTree(t1, "z");
        /*
         * Assert that values of variables match expectations
         */
